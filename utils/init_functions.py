...
def __init_random_between_vals__(n: int, lower_limit: float, upper_limit: float,
...
def init_random_between_vals_builder(lower_limit: float, upper_limit: float,
                                     random_state: np.random.Generator = None) -> Callable[[int], np.ndarray]:
...
def init_random_sample_vals_builder(to_sample: ArrayLike, random_state: np.random.Generator = None) -> Callable[
    [int], np.ndarray]:
